...
export default function slackin ({
  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('meta name="robots" content="noindex"'),
        dom('meta name="googlebot" content="noindex"'),
      ...
      splash({ coc, path, css, name, org, logo, channels, gcaptcha_sitekey})
    )
  ...
  app.get('/iframe', (req, res) => {
    ...
    res.type('html')
    res.send(iframe({ path, large }).toHTML())
  })
  ...
  app.get('/iframe/dialog', (req, res) => {
    ...
    let page = dom('html',
      dom("script src=https://www.google.com/recaptcha/api.js"),
      splash({ coc, path, name, org, channels, large, iframe: true, gcaptcha_sitekey })
    )
    res.type('html')
    res.send(page.toHTML())
  })
