...
function slackin(_ref) {
  ...
  app.get('/iframe', function (req, res) {
    ...
    res.type('html');
    res.send((0, _iframe2.default)({ path: path, large: large }).toHTML());
  });
  ...
  app.get('/iframe/dialog', function (req, res) {
    ...
    if (!name) return res.send(404);
    var page = (0, _vd2.default)('html', (0, _vd2.default)("script src=https://www.google.com/recaptcha/api.js"), (0, _splash2.default)({ coc: coc, path: path, name: name, org: org, channels: channels, large: large, iframe: true, gcaptcha_sitekey: gcaptcha_sitekey }));
    res.type('html');
    res.send(page.toHTML());
  });
