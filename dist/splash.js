...
function splash(_ref) {
  ...
  channels && channels.length === 1 && (0, _vd2.default)('span', ' #', channels[0]), ' on Slack.'), (0, _vd2.default)('form id=invite', channels && (channels.length > 1
